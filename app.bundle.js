...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return DogApi; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar DogApi = /*#__PURE__*/function () {\n  function DogApi() {\n    _classCallCheck(this, DogApi);\n\n    this.baseUrl = 'https://dog.ceo/api';\n    this.breedsUrl = \"\".concat(this.baseUrl, \"/breeds/list\");\n  }\n\n  _createClass(DogApi, [{\n    key: \"getImagesUrl\",\n    value: function getImagesUrl(imageCount, breed) {\n      var url = ''; // returns the specified breed\n\n      if (breed != undefined) {\n        url = \"\".concat(this.baseUrl, \"/breed/\").concat(breed, \"/images/random/\").concat(imageCount);\n        return url;\n      } // return random images if breed was not specified\n\n\n      url = \"\".concat(this.baseUrl, \"/breeds/image/random/\").concat(imageCount);\n      return url;\n    }\n  }, {\n    key: \"getImages\",\n    value: function () {\n      var _getImages = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var imageCount,\n            breed,\n            dogApiurl,\n            response,\n            data,\n            _args = arguments;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                imageCount = _args.length > 0 && _args[0] !== undefined ? _args[0] : 10;\n                breed = _args.length > 1 ? _args[1] : undefined;\n                dogApiurl = this.getImagesUrl(imageCount, breed);\n                _context.next = 5;\n                return fetch(dogApiurl);\n\n              case 5:\n                response = _context.sent;\n                _context.next = 8;\n                return response.json();\n\n              case 8:\n                data = _context.sent;\n\n                if (response.ok) {\n                  _context.next = 11;\n                  break;\n                }\n\n                return _context.abrupt(\"return\", Promise.reject(response));\n\n              case 11:\n                return _context.abrupt(\"return\", data);\n\n              case 12:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function getImages() {\n        return _getImages.apply(this, arguments);\n      }\n\n      return getImages;\n    }()\n  }, {\n    key: \"getBreedsList\",\n    value: function () {\n      var _getBreedsList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n        var response, data;\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                _context2.next = 2;\n                return fetch(this.breedsUrl);\n\n              case 2:\n                response = _context2.sent;\n                _context2.next = 5;\n                return response.json();\n\n              case 5:\n                data = _context2.sent;\n\n                if (response.ok) {\n                  _context2.next = 8;\n                  break;\n                }\n\n                return _context2.abrupt(\"return\", Promise.reject(data));\n\n              case 8:\n                return _context2.abrupt(\"return\", data);\n\n              case 9:\n              case \"end\":\n                return _context2.stop();\n            }\n          }\n        }, _callee2, this);\n      }));\n\n      function getBreedsList() {\n        return _getBreedsList.apply(this, arguments);\n      }\n\n      return getBreedsList;\n    }()\n  }]);\n\n  return DogApi;\n}();\n\n\n\n//# sourceURL=webpack:///./src/scripts/DogApi.js?");
...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./src/styles/bootstrap.scss?");
